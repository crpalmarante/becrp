...
def create_from_commission(*, employee_id, employee_name, partner_id=None, period, valor,
                           vencimento=None, comissao_ids=None, usuario=""):
    """
    ...
    row = {
        "id": tid,
        "seq": seq,
        "partner_id": str(partner_id or employee_id),
