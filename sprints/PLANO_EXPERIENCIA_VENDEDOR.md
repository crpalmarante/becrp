...
1. Fechar modelo Organização/Estabelecimento no código (`RFC-ORGANIZATION-ESTABLISHMENT.md`) — terminal × pessoa já decidido; falta preço local e 1:1 vendedor↔PDV.
