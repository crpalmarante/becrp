       ...
       *> gerir_filiais.cbl - CRUD de filiais
       ...
       PROCEDURE DIVISION.
        ...
        incluir.
            ...
            MOVE ws-empresa-id-num TO fl-empresa-id
            WRITE fil-reg
            CLOSE fil-file
            DISPLAY ws-prox-id.
       ...
       listar.
           ...
           PERFORM UNTIL 1 = 2
               ...
               END-IF
                ...
                MOVE fl-empresa-id TO ws-empresa-j
