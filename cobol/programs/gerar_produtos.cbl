       ...
       *> gerar_produtos.cbl - Gera dados iniciais de produtos e vendas
       ...
       01 item-reg.
        ...
        gerar-produtos.
           ...
           MOVE "7891234560018" TO pr-codigo-barras
            MOVE "Alimentacao" TO pr-categoria
            MOVE "Graos" TO pr-sub-categoria
            MOVE "UN" TO pr-unidade MOVE "10063021" TO pr-ncm
           ...
           MOVE "7891234560025" TO pr-codigo-barras
            MOVE "Alimentacao" TO pr-categoria
            MOVE "Graos" TO pr-sub-categoria
            MOVE "UN" TO pr-unidade MOVE "07133319" TO pr-ncm
            MOVE "Fornecedor A" TO pr-fornecedor
           ...
           MOVE "7891234560032" TO pr-codigo-barras
            MOVE "Alimentacao" TO pr-categoria
            MOVE "Oleos" TO pr-sub-categoria
            MOVE "UN" TO pr-unidade MOVE "15079011" TO pr-ncm
           ...
           MOVE "7891234560049" TO pr-codigo-barras
            MOVE "Alimentacao" TO pr-categoria
            MOVE "Acucares" TO pr-sub-categoria
            MOVE "UN" TO pr-unidade MOVE "17011400" TO pr-ncm
            MOVE "Fornecedor A" TO pr-fornecedor
           ...
           MOVE "7891234560056" TO pr-codigo-barras
            MOVE "Alimentacao" TO pr-categoria
            MOVE "Cafes" TO pr-sub-categoria
            MOVE "UN" TO pr-unidade MOVE "09012100" TO pr-ncm
           ...
           MOVE "7891234560063" TO pr-codigo-barras
            MOVE "Bebidas" TO pr-categoria
            MOVE "Leites" TO pr-sub-categoria
            MOVE "UN" TO pr-unidade MOVE "04012010" TO pr-ncm
            MOVE "Fornecedor B" TO pr-fornecedor
           ...
           MOVE "7891234560070" TO pr-codigo-barras
            MOVE "Padaria" TO pr-categoria
            MOVE "Paes" TO pr-sub-categoria
            MOVE "UN" TO pr-unidade MOVE "19059090" TO pr-ncm
           ...
           MOVE "7891234560087" TO pr-codigo-barras
            MOVE "Bebidas" TO pr-categoria
            MOVE "Refrigerantes" TO pr-sub-categoria
            MOVE "UN" TO pr-unidade MOVE "22021000" TO pr-ncm
            MOVE "Fornecedor B" TO pr-fornecedor
           ...
           MOVE "7891234560094" TO pr-codigo-barras
            MOVE "Limpeza" TO pr-categoria
            MOVE "Saboes" TO pr-sub-categoria
            MOVE "UN" TO pr-unidade MOVE "34025000" TO pr-ncm
           ...
           MOVE "7891234560100" TO pr-codigo-barras
            MOVE "Limpeza" TO pr-categoria
