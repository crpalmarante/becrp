       ...
       *> batch_json_produtos.cbl — produtos.dat (SEQUENTIAL) → produtos.json
       ...
       PROCEDURE DIVISION.
           ...
           IF ws-fs = "35" THEN
               ...
               MOVE '{"produtos":[],"total":0}' TO json-line
               WRITE json-line
               CLOSE json-file
               DISPLAY "JSON produtos gerado: 0 produtos"
               STOP RUN
           END-IF
           OPEN OUTPUT json-file
           MOVE 0 TO ws-total
           ...
           MOVE SPACES TO json-line
           STRING '],"total":' FUNCTION TRIM(ws-total-ed) '}' INTO json-line
           WRITE json-line
           CLOSE prod-file
           CLOSE json-file
           DISPLAY "JSON produtos gerado: " FUNCTION TRIM(ws-total-ed)
                   " produtos".
